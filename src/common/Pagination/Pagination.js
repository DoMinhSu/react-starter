...
function Pagination({ totalPage, currentPage = 1, pageCount = 7, isNextPrevious = true, isJumpNextPrevious = true,handleChangePage }) {
...
// 1 45 |6| 78 20 //////////////14 15 16 |17| 18 19 20     ( ((pageCount - 2) -1)/2 )     currentPage < total - ( ((pageCount - 2) -1)/2 )
        ...
        if(totalPage<pageCount){
            for (let index = 1; index <= totalPage; index++) {
                ...
                result.push (<PaginationItem handleChangePage={handleChangePage} key={index} page={index} />)
            }
             return result
        }
        ...
        if (currentPage <= pageCountInCenter || currentPage<=0) {
            ...
            result = insert(pageCount,<PaginationItem handleChangePage={handleChangePage} key={"currentPage+1"} page={currentPage+1} children={">>"}/>,result)
        }
        ...
        if(currentPage >pageCountInCenter && currentPage<totalPage-pageNeighbours){
            ...
            result = insert(pageCount+1,<PaginationItem handleChangePage={handleChangePage} key={"currentPage-1"} page={currentPage-1}  children={"<<"}/>,result)
        ...
        if( (currentPage>=totalPage-pageNeighbours && currentPage<=totalPage) || currentPage>totalPage){            
            ...
            result = insert(0,<PaginationItem handleChangePage={handleChangePage} key={"currentPage-1"} page={currentPage-1}  children={"<<"}/>,result)
        ...
        result = insert(0,<PaginationItem handleChangePage={handleChangePage} key={1} page={1}/>,result)
        result = insert(pageCount+1,<PaginationItem handleChangePage={handleChangePage} key={totalPage} page={totalPage}/>,result)
